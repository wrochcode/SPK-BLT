        ...
        <div style="margin-bottom: 15px">
          ...
          <form action="{{ route('alternatifalls.update', $alternatifall->id) }}" method="post">
            ...
            <div class="mb-2">
              <div class="mb-2">
                <h5> Kriteria_id</h5>
                <input type="text" name="id_kriteria" class="form-control " value="{{ $alternatifall->id_kriteria }}"
                  placeholder="the name of the kriteria">
              </div>
              <div class="mb-2">
                <h5> SubKriteria_id</h5>
                <input type="text" name="id_subkriteria" class="form-control "
                  value="{{ $alternatifall->id_subkriteria }}" placeholder="the name of the subkriteria">
              </div>
              <div class="mb-2">
