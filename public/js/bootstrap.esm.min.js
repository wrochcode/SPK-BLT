...
function bootstrapDelegationHandler(e, t, n) {
  return function i(s) {
    ...
    for (let { target: r } = s; r && r !== this; r = r.parentNode)
      for (let a = o.length; a--; ) if (o[a] === r) return (s.delegateTarget = r), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(r, [s]);
    return null;
  };
}
...
const EventHandler = {
    ...
    trigger(e, t, n) {
      ...
      return (
        o &&
          i &&
          ((a = i.Event(t, n)), i(e).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (E = a.isDefaultPrevented())),
...
class Carousel extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$9, ...Manipulator.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), typeCheckConfig(NAME$a, e, DefaultType$9), e
    );
  }
  _handleSwipe() {
  ...
  _addEventListeners() {
    this._config.keyboard && EventHandler.on(this._element, EVENT_KEYDOWN, (e) => this._keydown(e)),
      "hover" === this._config.pause &&
        (EventHandler.on(this._element, EVENT_MOUSEENTER, (e) => this.pause(e)), EventHandler.on(this._element, EVENT_MOUSELEAVE, (e) => this.cycle(e))),
...
EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$4, function (e) {
  ...
  SelectorEngine.find(n).forEach((e) => {
    ...
    let i;
    n ? (null === n._parent && "string" == typeof t.parent && ((n._config.parent = t.parent), (n._parent = n._getParent())), (i = "toggle")) : (i = t),
...
class Dropdown extends BaseComponent {
  ...
  _completeHide(e) {
    EventHandler.trigger(this._element, EVENT_HIDE$4, e).defaultPrevented ||
      ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e) => EventHandler.off(e, "mouseover", noop)),
...
class Backdrop {
  ...
  _getConfig(e) {
    return ((e = { ...Default$6, ...("object" == typeof e ? e : {}) }).rootElement = getElement(e.rootElement)), typeCheckConfig(NAME$7, e, DefaultType$6), e;
  }
  _append() {
    this._isAppended ||
...
class Modal extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$5, ...Manipulator.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), typeCheckConfig(NAME$6, e, DefaultType$5), e
    );
  }
  _showElement(e) {
    const t = this._isAnimated(),
...
class Offcanvas extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$4, ...Manipulator.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), typeCheckConfig(NAME$5, e, DefaultType$4), e
    );
  }
  _initializeBackDrop() {
    return new Backdrop({ isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
  }
...
EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, function (e) {
  ...
  EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => SelectorEngine.find(OPEN_SELECTOR).forEach((e) => Offcanvas.getOrCreateInstance(e).show())),
...
class Tooltip extends BaseComponent {
  ...
  setElementContent(e, t) {
    if (null !== e)
      return isElement(t)
        ? ((t = getElement(t)), void (this._config.html ? t.parentNode !== e && ((e.innerHTML = ""), e.appendChild(t)) : (e.textContent = t.textContent)))
  ...
  _initializeOnDelegatedTarget(e, t) {
    ...
    return (
      (t = t || Data.get(e.delegateTarget, n)) || ((t = new this.constructor(e.delegateTarget, this._getDelegateConfig())), Data.set(e.delegateTarget, n, t)), t
    );
  }
  _getOffset() {
    const { offset: e } = this._config;
...
class ScrollSpy extends BaseComponent {
  ...
  _getConfig(e) {
    if (
      "string" != typeof (e = { ...Default$1, ...Manipulator.getDataAttributes(this._element), ...("object" == typeof e && e ? e : {}) }).target &&
      isElement(e.target)
    ) {
      let { id: t } = e.target;
