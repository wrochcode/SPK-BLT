...
!(function (t, e) {
  ...
  const B = {
      ...
      trigger(t, e, s) {
        ...
        return (
          o &&
            i &&
            ((a = i.Event(e, s)), i(t).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (h = a.isDefaultPrevented())),
  ...
  class jt extends q {
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || W.get(t.delegateTarget, s)) || ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), W.set(t.delegateTarget, s, e)), e
      );
    }
    _getOffset() {
      const { offset: t } = this._config;
